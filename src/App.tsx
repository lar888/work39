  ...
  return (
    <div>
      ...
      <StatefulComponent
        ...
        author = "Jake Jacoby"
        date = "July 2025"
        summary = "In January 2020, I had the opportunity to travel to Costa Rica in Central America. I departed from Tampa, changed planes in Miami and then arrived in San Jose, the capital of Costa Rica. The Costa Rica Colon is the country's currency and was named after Christopher Columbus. The currency bills...."
